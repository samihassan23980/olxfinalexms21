  ...
  return (
    <>
      <div className="w-full   h-auto">
        <ul className="w-[80%] py-3  mx-auto flex justify-between flex-wrap">
          <div className="w-40  h-40 ">
            <div className="w-20 h-20  bg-yellow-400 border rounded-full">
              <img src="https://www.olx.com.pk/assets/mobiles.8c768c96bfde33f18fcf5af2a8b9cf71.png" />
            </div>
            <p className="absolute indent-2 ">Mobiles</p>
          </div>
          <div className="w-40  h-40 ">
            <div className="w-20 h-20  bg-yellow-400 border rounded-full">
